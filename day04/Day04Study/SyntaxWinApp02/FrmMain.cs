namespace SyntaxWinApp02
{
    public partial class FrmMain : Form
    {
        ...
        private void BtnCheck_Click(object sender, EventArgs e)
        {
            ...
            List<string> lFruit = ["용과", "망고스틱", "애플망고", "자몽", "두리안"];
            //List<string> lFruits = new List<string>();
            //lFruits.Append<string>("용과");
            //lFruits.Append<string>("망고스틴");
            //lFruits.Append<string>("애플망고");
            //lFruits.Append<string>("자몽");
            CboList.DataSource = lFruit;
